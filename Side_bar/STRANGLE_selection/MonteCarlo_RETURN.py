...
def monteCarlo_exp_return(underlying, rate,  sigma_call, sigma_put, days_to_expiration, closing_days_array, trials, initial_credit,
    ...
    sigma_call = sigma_call / 100
    sigma_put = sigma_put / 100
    ...
    for c in range(trials):
        ...
        for r in range(max_closing_days + 1):
            ...
            debit = bsm_func(stock_price, strikes, rate, dt * (days_to_expiration - r),  sigma_call, sigma_put, instr_type)
