...
def f_strangle():
    ...
    # ============================================     add new position
    # ============================================
    with st.expander('Add New F. Strangle'):
        ...
        with col13:
            ...
            strike_o_p_p = st.number_input('Strike Put', step=0.5, format="%.1f", min_value=1., max_value=5000., value=100.)
            strike_o_p_c = st.number_input('Strike Call', step=0.5, format="%.1f", min_value=1., max_value=5000., value=100.)
    ...
    # ============================================
        ...
        if st.button("Open", type="primary"):
            input_new_df = pd.DataFrame({
                ...
                'Strike_o_p_p': [strike_o_p_p],
                'Strike_o_p_c': [strike_o_p_c],
