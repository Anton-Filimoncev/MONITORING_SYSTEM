...
from .barchart.barchart_112 import barchart_selection
import os
...
def f_ratio_112():
    ...
    if infoType_barchart:
        ...
        folder_path = 'Side_bar/BARCHART_DATA/112'  # Замените на путь к вашей папке
        ...
        if barchart_button:
            return_df, best_df = barchart_selection(short_df, long_df, side, short_dte, long_dte, tick, rate, percentage_array, multiplier)
